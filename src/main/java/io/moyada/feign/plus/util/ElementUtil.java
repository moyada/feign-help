package io.moyada.feign.plus.util;
...
//            Symbol.ClassSymbol typeElement = treeMaker.getTypeElement(ident.sym.toString());
//            JCTree.JCClassDecl sup = (JCTree.JCClassDecl) trees.getTree(typeElement);
